...
import ru.t1.java.service3.exception.TransactionException;
import ru.t1.java.service3.kafka.KafkaAccountProducer;
...
@Service
@Slf4j
public class AccountServiceImpl implements AccountService, UnblockService {
    @Value("${spring.kafka.topic.accounts}")
    private String topic;
    @Value("${unblock.accounts}")
